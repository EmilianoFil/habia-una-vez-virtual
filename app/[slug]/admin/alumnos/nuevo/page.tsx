...
const EMPTY_CONTACTO: ContactoEmergencia = { nombre: '', relacion: '', telefono: '' }
  ...
  async function handleGuardar() {
    ...
    try {
      ...
      await createAlumno(tenant.id, {
        ...
        datosMedicos: { alergias, medicacionHabitual: medicacion, obraSocial, pediatraNombre, pediatraTelefono },
